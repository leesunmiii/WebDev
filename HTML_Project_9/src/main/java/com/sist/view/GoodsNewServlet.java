...
public class GoodsNewServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.write("<h1 class=text-center>신제품</h1>");
		for(GoodsVO vo:list)
		{
			String s=vo.getName();
			if(s.length()>30)
		...
		{	
			out.write("<li><a href=MainListServlet?page="+(startpage-1)+"&mode=4>&lt;</a></li>");
			// 11page => 이전 => 10
		}
		...
		{
			out.write("<li><a href=MainListServlet?page="+(endpage+1)+"&mode=4>&gt;</a></li>");
		}
