...
public class GoodsSpecialServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for(GoodsVO vo:list)
		{
			...
			out.write("<a href=MainServlet?mode=5&no="+vo.getNo()+"&type=2>"); // 클릭할 때 상세보기 넘어가는 (링크 걸리는 위치)
		...
		{	
			out.write("<li><a href=MainListServlet?page="+(startpage-1)+"&mode=2>&lt;</a></li>");
			// 11page => 이전 => 10
		}
		...
		{
			out.write("<li><a href=MainListServlet?page="+(endpage+1)+"&mode=2>&gt;</a></li>");
		}
